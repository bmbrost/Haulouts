...
tune <- list(sigma=0.05,sigma.mu=0.2,mu.0=2,gamma=2.0)
...
matplot(out1$gamma[idx,-1],type="l"); abline(h=gamma[-1],col=1:3,lty=2) 
...
matplot(mod$beta[idx,-1],type="l"); abline(h=beta,col=1:3,lty=2) 
